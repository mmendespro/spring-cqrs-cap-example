...
public class BookCreatedEvent extends AbstractDomainEvent {

    private final Book book;
    private long eventTime;

    public BookCreatedEvent(final ObjectMapper mapper, final Book book) {
        super(mapper);
        this.book = book;
    ...
    public static BookCreatedEvent of(final ObjectMapper mapper, final Book book) {
        return new BookCreatedEvent(mapper, book);
    }
}
